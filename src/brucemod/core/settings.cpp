...
void setWifiApSsidMenu() {
    const bool isDefault = bruceConfig.wifiAp.ssid == "BruceModNet";

    options = {
        {"Default (BruceModNet)",
         [=]() { bruceConfig.setWifiApCreds("BruceModNet", bruceConfig.wifiAp.pwd); },
         isDefault                                                                            },
        {"Custom",
         [=]() {
...
void setWifiApPasswordMenu() {
    const bool isDefault = bruceConfig.wifiAp.pwd == "brucemod";

    options = {
        {"Default (brucemod)",
         [=]() { bruceConfig.setWifiApCreds(bruceConfig.wifiAp.ssid, "brucemod"); },
         isDefault                                                                             },
        {"Custom",
         [=]() {
...
bool appStoreInstalled() {
    ...
    return fs->exists("/BruceModJS/Tools/App Store.js");
}
...
void installAppStoreJS() {
    ...
    if (!fs->exists("/BruceModJS")) {
        if (!fs->mkdir("/BruceModJS")) {
            displayWarning("Failed to create /BruceJS directory", true);
            return;
        }
    }

    if (!fs->exists("/BruceModJS/Tools")) {
        if (!fs->mkdir("/BruceModJS/Tools")) {
    ...
    File file = fs->open("/BruceModJS/Tools/App Store.js", FILE_WRITE);
    if (!file) {
...
/*********************************************************************
**  Function: setMenuStyleMenu
**  Submenu to select menu style
**********************************************************************/
void setMenuStyleMenu() {
    options = {
        {"List",     []() { bruceConfig.setMenuStyle(0); }},
        {"Wii",      []() { bruceConfig.setMenuStyle(1); }},
        {"Dsi",      []() { bruceConfig.setMenuStyle(2); }},
        {"Ps4",      []() { bruceConfig.setMenuStyle(3); }},
        {"Vertical", []() { bruceConfig.setMenuStyle(4); }},
        {"C64",      []() { bruceConfig.setMenuStyle(5); }},
        {"Back",     []() {}}
    };
    loopOptions(options, MENU_TYPE_SUBMENU, "Main Menu Mode");
}

void setSubMenuStyleMenu() {
    options = {
        {"List",     []() { bruceConfig.setSubMenuStyle(0); }},
        {"Wii",      []() { bruceConfig.setSubMenuStyle(1); }},
        {"Dsi",      []() { bruceConfig.setSubMenuStyle(2); }},
        {"Ps4",      []() { bruceConfig.setSubMenuStyle(3); }},
        {"Vertical", []() { bruceConfig.setSubMenuStyle(4); }},
        {"C64",      []() { bruceConfig.setSubMenuStyle(5); }},
        {"Back",     []() {}}
    };
    loopOptions(options, MENU_TYPE_SUBMENU, "SubMenu Mode");
}
