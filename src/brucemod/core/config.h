...
public:
    ...
    const char *filepath = "/brucemod.conf";
    ...
    // Wifi
    Credential webUI = {"admin", "brucemod"};
    std::vector<String> webUISessions = {}; // FIFO queue of session tokens
    WiFiCredential wifiAp = {"BruceModNet", "brucemod"};
    ...
    int menuStyle = 0; // 0: List, 1: Wii, 2: Dsi, 3: Ps4, 4: Vertical, 5: C64
    int subMenuStyle = 5;
    ...
    std::vector<QrCodeEntry> qrCodes = {
        {"BruceMod AP", "WIFI:T:WPA;S:BruceModNet;P:brucemod;;"},
    ...
    void setMenuStyle(int value);
    void validateMenuStyleValue();
    void setSubMenuStyle(int value);
    void validateSubMenuStyleValue();
    void setDebugMode(bool value);
    void setBatteryWarningShown(bool value);
    void setStatusLight(bool value);
