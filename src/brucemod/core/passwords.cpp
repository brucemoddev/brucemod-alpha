...
String readDecryptedFile(FS &fs, String filepath) {
    ...
    while (cyphertextFile.available()) {
        ...
        if (line.startsWith("Filetype:") && !line.endsWith("Bruce Encrypted File") && !line.endsWith("BruceMod Encrypted File")) unsupported_params = true;
...
String encryptString(String &plaintext, const String &password_str) {
    ...
    String out = "Filetype: BruceMod Encrypted File\nVersion: 1\n";
    out += "Algo: XOR\n"; // TODO: add AES
