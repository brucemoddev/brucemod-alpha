...
#include "modules/badusb_ble/mouse_jiggler.h"
...
#include "modules/others/partition_viewer.h"
#include "modules/others/games_menu.h"
#include "modules/others/music_player_v2.h"
...
#endif
        {"Partition Viewer", partition_viewer_setup   },
        {"Games",            games_menu_setup         },
        {"Advance Music",    music_player_v2_setup    },
    };
...
void OthersMenu::badUsbHidMenu() {
    options = {
        ...
        {"Mouse Jiggler", [=]() { mouse_jiggler_setup(hid_usb, false); }},
#endif
