...
void ConfigMenu::displayUIMenu() {
    while (true) {
        std::vector<Option> localOptions = {
            ...
            {"Main Mode",   [this]() { setMenuStyleMenu(); }                },
            {"Sub Mode",    [this]() { setSubMenuStyleMenu(); }             },
            {"Debug Info",  [=]() { bruceConfig.setDebugMode(!bruceConfig.debugMode); }},
            {"Reset BattWarn", [=]() { bruceConfig.setBatteryWarningShown(false); displaySuccess("Warning reset", true); }},
            {"Back",        []() {}                                         },
        };
...
void ConfigMenu::ledMenu() {
    while (true) {
        std::vector<Option> localOptions = {
            ...
            {String("Busy Light: ") + (bruceConfig.statusLight ? "ON" : "OFF"),
             [this]() {
                 bruceConfig.setStatusLight(!bruceConfig.statusLight);
             }                                                                            },
            {"Back",                                                               []() {}},
        };
