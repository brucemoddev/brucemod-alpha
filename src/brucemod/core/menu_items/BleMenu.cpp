...
#include "modules/ble/wall_of_flippers.h"
#include "modules/ble/skimmer_detector.h"
#include "modules/ble/wall_of_airtags.h"
#include "modules/ble/airtag_spoof.h"
#include <globals.h>
...
void BleMenu::optionsMenu() {
    ...
    options.push_back({"Wall of Flippers", wall_of_flippers_setup});
    options.push_back({"Skimmer Detector", skimmer_detector_setup});
    options.push_back({"Wall of AirTags", wall_of_airtags_setup});
    options.push_back({"Airtag Spoof", airtag_spoof_setup});
