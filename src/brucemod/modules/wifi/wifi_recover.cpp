// --- wifi_recover.cpp ---
/*
  WiFi Password Cracker for BruceMod (ESP32-S3 / T-Embed)
...
void wifi_recover_menu() {
    ...
    // Ensure BruceModPCAP folder exists, create if needed
    const String PCAP_DIR = "/BruceModPCAP";
